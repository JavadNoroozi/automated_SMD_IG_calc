...
def main(smile_list, numConfs=100, maxAttempts= 500, pruneRmsThresh= 0.1, clusterMethod="RMSD", clusterThreshold = 2.0, minimizeIterations = 0.0):

	suppl = [Chem.MolFromSmiles(i) for i in smile_list]
	i=0
	for mol in suppl:
		i = i+1
		...
		write_conformers_to_sdf(m, smile_list[i-1] + "_confs.sdf", rmsClusters, conformerPropsDict, minEnergy)


if __name__=="main":
	main(smile_list, numConfs, maxAttempts, pruneRmsThresh,clusterMethod, clusterThreshold, minimizeIterations)
